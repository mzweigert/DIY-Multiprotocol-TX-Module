...
enum PROTOCOLS
{
	...
	PROTO_BUGSMINI	= 1,	// =>NRF24L01
	PROTO_BAYANG	= 2,	// =>NRF24L01
	PROTO_MJXQ		= 3,	// =>NRF24L01
	
	PROTO_FLYSKY 	= -1,	// =>A7105
	PROTO_HUBSAN	= -1,	// =>A7105
	PROTO_FRSKYD	= -1,	// =>CC2500
	PROTO_HISKY		= -1,	// =>NRF24L01
	PROTO_V2X2		= -1,	// =>NRF24L01
	PROTO_DSM		= -1,	// =>CYRF6936
	PROTO_DEVO		= -1,	// =>CYRF6936
	PROTO_YD717		= -1,	// =>NRF24L01
	PROTO_KN		= -1,	// =>NRF24L01
	PROTO_SYMAX		= -1,	// =>NRF24L01
	PROTO_SLT		= -1,	// =>NRF24L01
	PROTO_CX10		= -1,	// =>NRF24L01
	PROTO_CG023		= -1,	// =>NRF24L01
	PROTO_FRSKYX	= -1,	// =>CC2500
	PROTO_ESKY		= -1,	// =>NRF24L01
	PROTO_MT99XX	= -1,	// =>NRF24L01
	PROTO_SHENQI	= -1,	// =>NRF24L01
	PROTO_FY326		= -1,	// =>NRF24L01
	PROTO_FUTABA	= -1,	// =>CC2500
	PROTO_J6PRO		= -1,	// =>CYRF6936
	PROTO_FQ777		= -1,	// =>NRF24L01
	PROTO_ASSAN		= -1,	// =>NRF24L01
	PROTO_FRSKYV	= -1,	// =>CC2500
	PROTO_HONTAI	= -1,	// =>NRF24L01
	PROTO_OPENLRS	= -1,	// =>OpenLRS hardware
	PROTO_AFHDS2A	= -1,	// =>A7105
	PROTO_Q2X2		= -1,	// =>NRF24L01, extension of CX-10 protocol
	PROTO_WK2x01	= -1,	// =>CYRF6936
	PROTO_Q303		= -1,	// =>NRF24L01
	PROTO_GW008		= -1,	// =>NRF24L01
	PROTO_DM002		= -1,	// =>NRF24L01
	PROTO_CABELL	= -1,	// =>NRF24L01
	PROTO_ESKY150	= -1,	// =>NRF24L01
	PROTO_H8_3D		= -1,	// =>NRF24L01
	PROTO_CORONA	= -1,	// =>CC2500
	PROTO_CFLIE     = -1,   // =>NRF24L01
	PROTO_HITEC     = -1,   // =>CC2500
	PROTO_WFLY		= -1,	// =>CYRF6936
	PROTO_BUGS		= -1,	// =>A7105
	PROTO_TRAXXAS	= -1,	// =>CYRF6936
	PROTO_NCC1701	= -1,	// =>NRF24L01
	PROTO_E01X		= -1,	// =>NRF24L01
	PROTO_V911S		= -1,	// =>NRF24L01
	PROTO_GD00X		= -1,	// =>NRF24L01
	PROTO_V761		= -1,	// =>NRF24L01
	PROTO_KF606		= -1,	// =>NRF24L01
	PROTO_REDPINE	= -1,	// =>CC2500
	PROTO_POTENSIC	= -1,	// =>NRF24L01
	PROTO_ZSX		= -1,	// =>NRF24L01
	PROTO_HEIGHT	= -1,	// =>A7105
	PROTO_SCANNER	= -1,	// =>CC2500
	PROTO_FRSKY_RX	= -1,	// =>CC2500
	PROTO_AFHDS2A_RX= -1,	// =>A7105
	PROTO_HOTT		= -1,	// =>CC2500
	PROTO_FX816		= -1,	// =>NRF24L01
	PROTO_BAYANG_RX	= -1,	// =>NRF24L01
	PROTO_PELIKAN	= -1,	// =>A7105
	PROTO_TIGER		= -1,	// =>NRF24L01
	PROTO_XK		= -1,	// =>NRF24L01
	PROTO_XN297DUMP	= -1,	// =>NRF24L01
	PROTO_FRSKYX2	= -1,	// =>CC2500
	PROTO_FRSKY_R9	= -1,	// =>SX1276
	PROTO_PROPEL	= -1,	// =>NRF24L01
	PROTO_FRSKYL	= -1,	// =>CC2500
	PROTO_SKYARTEC	= -1,	// =>CC2500
	PROTO_ESKY150V2	= -1,	// =>CC2500+NRF24L01
	PROTO_DSM_RX	= -1,	// =>CYRF6936
	PROTO_JJRC345	= -1,	// =>NRF24L01
	PROTO_Q90C		= -1,	// =>NRF24L01 or CC2500
	PROTO_KYOSHO	= -1,	// =>A7105
	PROTO_RLINK		= -1,	// =>CC2500
	PROTO_REALACC	= -1,	// =>NRF24L01
	PROTO_OMP		= -1,	// =>CC2500 & NRF24L01
	PROTO_MLINK		= -1,	// =>CYRF6936
	PROTO_WFLY2		= -1,	// =>A7105
	PROTO_E016HV2	= -1,	// =>CC2500 & NRF24L01

	PROTO_NANORF	= -1,	// =>NRF24L01
	PROTO_TEST		= -1,	// =>CC2500*/
};
...
#define BLINK_MODE_TIME_HIGH		50
#define BLINK_MODE_TIME_LOW			250
#define BLINK_MODE_REPEAT			1500
