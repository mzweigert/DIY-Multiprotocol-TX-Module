...
/*  // Dial
  ...
  #else
    #define BIND_pin    A0          
    #define BIND_BTN_init   { pinMode(BIND_pin, INPUT); pinMode(BIND_pin, INPUT_PULLUP); };
    #define IS_BIND_BTN_on  ( digitalRead(BIND_pin) == LOW )
  #endif
  
  // UP
    #define UP_pin      A1            
    #define UP_BTN_init   { pinMode(UP_pin, INPUT); pinMode(UP_pin, INPUT_PULLUP); };
    #define IS_UP_BTN_on  ( digitalRead(UP_pin) == LOW )
  
  //DOWN
    #define DOWN_pin    A2          
    #define DOWN_BTN_init { pinMode(DOWN_pin, INPUT); pinMode(DOWN_pin, INPUT_PULLUP); };
    #define IS_DOWN_BTN_on  ( digitalRead(DOWN_pin) == LOW )
